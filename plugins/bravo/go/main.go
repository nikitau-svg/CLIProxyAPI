	...
	return registration{
		...
		Metadata: pluginapi.Metadata{
			...
			ConfigFields: []pluginapi.ConfigField{
				...
				{Name: "adaptive_allocator_mode", Type: pluginapi.ConfigFieldTypeString, Description: "Adaptive allocator: off, observe, or enforce. Enforce skips only a confirmed unsafe attempt and immediately continues the configured neighboring route; it never queues or adds provider requests."},
